...
import { Lock, Key, Trash2, Sparkles, CheckCircle2, ShieldAlert, Settings, MessageCircle, UserCheck } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full bg-wedding-bg text-wedding-maroon relative font-sans flex flex-col items-center justify-center p-4 sm:p-6 overflow-y-auto selection:bg-wedding-gold/30">
      ...
      <motion.div
        ...
        className="relative max-w-2xl w-full bg-wedding-card rounded-3xl p-6 sm:p-8 border border-wedding-gold shadow-2xl space-y-6 z-10 my-auto"
      >
        {!isAuthenticated ? (
          /* --- LOGIN FORM --- */
            ...
            <form onSubmit={handleLogin} className="max-w-sm mx-auto space-y-4 font-sans text-left">
              <div>
                ...
                <p className="text-[11px] text-wedding-maroon/50 mt-1">
                  Default passcode:{' '}
                  <code className="bg-wedding-ivory px-1.5 py-0.5 rounded border border-wedding-gold/30">
                    wedding123
                  </code>
                </p>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="border-b border-wedding-gold/20 pb-4 space-y-3">
              <div>
                ...
                <p className="font-sans text-xs text-wedding-maroon/70">
                  Manage Groom/Bride names, Gift Giver name, & wishes
                </p>
              </div>
                  ...
                  {wishes.map((item) => (
                    ...
                    >
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-wedding-maroon/80 italic">"{item.message}"</p>
                      </div>
        ...
        <div className="pt-3 text-center border-t border-wedding-gold/20">
          <a
            href="/"
