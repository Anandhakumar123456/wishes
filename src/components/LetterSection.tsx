      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center space-y-8">
        ...
        <div className="py-8 flex flex-col items-center justify-center">
          <motion.div
            ...
            className="relative w-80 sm:w-96 aspect-4/3 rounded-2xl bg-gradient-to-br from-wedding-card to-wedding-ivory-warm border border-wedding-gold/60 shadow-2xl p-6 flex flex-col items-center justify-center text-wedding-maroon cursor-pointer group envelope-shadow"
          ...
          >
            ...
            <div className="mt-4 font-serif text-lg font-bold text-wedding-maroon">
              To: {weddingConfig.brideName}
            </div>

            <div className="text-xs font-sans uppercase tracking-widest text-wedding-gold-dark mt-1">
        ...
        {isOpen && (
          ...
          >
            <motion.div
              ...
              className="relative max-w-2xl w-full my-8 bg-[#FAF7F2] text-[#4A0E17] rounded-3xl p-8 sm:p-12 border-2 border-wedding-gold shadow-2xl space-y-6"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Close Button */}
              <button
                onClick={() => setIsOpen(false)}
                className="absolute top-4 right-4 p-2.5 rounded-full bg-wedding-gold-light/40 text-wedding-maroon hover:bg-wedding-gold transition-colors"
              >
                <X className="w-5 h-5" />
              </button>

              {/* Top Handwritten Greeting */}
              <div className="border-b border-wedding-gold/30 pb-4">
                <span className="font-script text-4xl sm:text-5xl text-wedding-gold-dark block">
                  {weddingConfig.letterGreeting}
                </span>
              </div>

              {/* Emotional Letter Body */}
              <div className="space-y-4 font-sans text-base sm:text-lg text-wedding-maroon/90 leading-relaxed font-normal">
              ...
              {/* Closing Signature */}
              <div className="pt-6 border-t border-wedding-gold/30 flex flex-col items-end text-right">
                <span className="text-sm font-sans uppercase tracking-widest text-wedding-maroon/60">
                  {weddingConfig.letterClosing}
                </span>
                <span className="font-script text-3xl sm:text-4xl text-wedding-gold-dark font-bold mt-1">
